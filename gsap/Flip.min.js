! function(t, e) {
    ...
    var g, y, r, b, c, f, d, a, m, i, w = "transform",
        k = w + "Origin",
        C = [],
        E = [],
    ...
    function Aa(t, e, r, i) {
        ...
        }, H.push(p), p.sd && (p.sd < 0 && (p.b = d, p.a = n), J && fa(p.b, Y ? et[Y] : nt), A && H.push(p.swap = {
            t: n.element,
            b: p.b,
            a: p.a,
            sd: -p.sd,
        ...
        Y && (st[Y] || ba(Y)).forEach(function(e) {
            ...
            for (ea(H), za(!0), l = 0; l < H.length; l++) p = H[l], g = p.a, v = p.b, !D || g.isDifferent(v) || p.entering ? (u = p.t, !I || p.sd < 0 || !l || (g.matrix = getGlobalMatrix(u, !1, !1, !0)), v.isVisible && g.isVisible ? (p.sd < 0 ? (h = new pt(u, Y, t.simple), ot(h, g, T, 0, 0, h), h.matrix = getGlobalMatrix(u, !1, !1, !0), h.css = p.b.css, p.a = g = h, A && (u.style.opacity = J ? v.opacity : g.opacity), O && q.push(u)) : 0 < p.sd && A && (u.style.opacity = J ? g.opacity - v.opacity : "0"), ot(g, v, T, Y)) : v.isVisible !== g.isVisible && (v.isVisible ? g.isVisible || (v.css = g.css, G.push(v), H.splice(l--, 1), S && I && ot(g, v, T, Y)) : (g.isVisible && j.push(g), H.splice(l--, 1))), T || (u.style.maxWidth = Math.max(g.width, v.width) + "px", u.style.maxHeight = Math.max(g.height, v.height) + "px", u.style.minWidth = Math.min(g.width, v.width) + "px", u.style.minHeight = Math.min(g.height, v.height) + "px"), I && L && u.classList.add(L)) : H.splice(l--, 1), f.push(g);
            var e;
            if (L && (e = f.map(function(t) {
                    return t.element
                }), I && e.forEach(function(t) {
                    return t.classList.remove(L)
                })), za(!1), T ? (z.scaleX = function(t) {
                    return H[t].a.scaleX
                }, z.scaleY = function(t) {
                    return H[t].a.scaleY
                }) : (z.width = function(t) {
                ...
                }, z.zIndex = P, z.immediateRender = !1 !== r.immediateRender), A && (z.opacity = function(t) {
            ...
            (c.length || G.length || j.length) && (L && R.add(function() {
                return X(e, L, R._zTime < 0 ? "remove" : "add")
            }, 0) && !E && X(e, L, "add"), c.length && U.call(R, c, W, 0)), sa(b, j, R), sa(w, G, R);
    ...
    var U, K = ((U = FlipBatch.prototype).add = function add(e) {
        ...
        }), s = n, tt = t, this.killConflicts(), this
    ...
    var ht = (Flip.getState = function getState(t, e) {
        ...
        var n = i ? _(i, at) : {},
            ...
            d = j(t, 0, h, f),
            m = l ? et[l] : nt;
        return l && pa(n, f.props), u && (fa(d, m), "immediateRender" in n || (n.immediateRender = !0), n.onComplete = function() {
            ga(d), p && p.apply(this, arguments)
        }), a && ja(d, f), n = ot(d, f, s || c, l, c, n.duration || o ? n : 0), o ? n : n.duration ? Q.to(d.element, n) : null
    ...
    function Flip() {}
    ht.version = "3.12.0", "undefined" != typeof window && window.gsap && window.gsap.registerPlugin(ht), e.Flip = ht, e.default = ht;
